<template>
  ...
  >
    <h2 class="text-title-md2 font-bold text-black">Tambah Kuis {{ quiz }}</h2>
    <nav>
      <ol class="flex items-center gap-2">
        ...
        <li class="font-medium text-regal-blue-500">edit Kuis {{ quiz }}</li>
      </ol>
    </nav>
  </div>
...
const { id, curriculum, quiz } = useRoute().params as {
  id: string;
  curriculum: string;
  quiz: string;
};
