<template>
  ...
  >
    <div class="text-white">
      <h2 class="font-semibold text-4xl pb-2">Komputasi Awan</h2>
      <p class="text-xs text-justify md:text-sm max-w-lg">
        Komputasi awan atau komputasi gemawan adalah gabungan pemanfaatan
        teknologi komputer dan pengembangan berbasis Internet. Awan adalah
        metafora dari internet, sebagaimana awan yang sering digambarkan di
        ...
        <div class="shadow-md rounded-lg bg-white">
          ...
          <div class="px-6">
            <!-- <div class="flex justify-between">
              <h4 class="font-semibold text-sm mb-6 text-blue">Rp100.000</h4>
            ...
            <!-- <button
              class="w-full py-3 text-blue bg-white rounded-md text-center border-2 border-blue mb-8"
            >
              Beli Kelas
            </button> -->
