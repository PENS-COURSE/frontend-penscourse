<template>
  ...
  >
    <div class="text-white">
      <h2 class="font-semibold text-4xl pb-2">Teknik Informatika</h2>
      <p class="text-xs text-justify md:text-sm max-w-lg">
        Informatika merupakan ilmu yang baik mempelajari terkait penggunaan
        komputer untuk mengatur dan menganalisis data yang berukuran besar, baik
        data maupun informasi pada mesin berbasis komputasi.
      </p>
    </div>
  </section>
  ...
  <section class="mx-10 my-16 lg:mx-16 xl:mx-32">
    <div class="flex flex-col gap-10 items-center mb-16 md:flex-row xl:gap-0">
      ...
      <div class="xl:pl-32">
        <h4 class="font-semibold text-4xl text-blue mb-4">Peserta</h4>
        <p class="font-medium text-base text-gray2 text-justify">
          Materi ini disusun khusus bagi mereka yang tertarik untuk mempelajari
          Digital Marketing, dan sangat sesuai untuk pemula yang ingin
          meningkatkan kemampuan mereka dalam bidang ini. Dengan konten yang
          disesuaikan untuk tingkat awal, materi ini akan membantu Anda memahami
          dasar-dasar Digital Marketing dengan lebih baik.
        </p>
      </div>
    </div>
    ...
    <div class="flex flex-col gap-10 items-center mb-16 md:flex-row xl:gap-0">
      <div class="xl:pr-32">
        <h4 class="font-semibold text-4xl text-blue mb-4">Peluang</h4>
        <p class="font-medium text-base text-gray2 text-justify">
          Materi ini disusun khusus bagi mereka yang tertarik untuk mempelajari
          Digital Marketing, dan sangat sesuai untuk pemula yang ingin
          meningkatkan kemampuan mereka dalam bidang ini. Dengan konten yang
    ...
    <div class="flex flex-col gap-10 items-center md:flex-row xl:gap-0">
      ...
      <div class="xl:pl-32">
        <h4 class="font-semibold text-4xl text-blue mb-4">Benefit</h4>
        <p class="font-medium text-base text-gray2 text-justify">
          Materi ini disusun khusus bagi mereka yang tertarik untuk mempelajari
          Digital Marketing, dan sangat sesuai untuk pemula yang ingin
          meningkatkan kemampuan mereka dalam bidang ini. Dengan konten yang
  ...
  <section class="mx-10 lg:mx-16 xl:mx-32">
    <h4 class="font-semibold text-3xl text-blue">Mata Kuliah Terpopuler</h4>
    <div
    ...
    <div class="flex justify-center mt-8">
      <NuxtLink
        to="/major/informatika/detail"
        class="border border-blue bg-white text-blue py-2 px-6 rounded-lg hover:bg-blue hover:text-white transition-colors"
